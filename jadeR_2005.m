...
%  Preallocation is not recommended here
...
%% Init
% disp i;
if 0 	%% Init by diagonalizing a *single* cumulant matrix.
    %% It seems to save some computation time `sometimes'.
    %% Not clear if initialization is really worth it
    %% since Jacobi rotations are very efficient.
